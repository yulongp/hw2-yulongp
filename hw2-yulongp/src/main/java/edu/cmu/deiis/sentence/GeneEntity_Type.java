...
public class GeneEntity_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("edu.cmu.deiis.sentence.GeneEntity");
  ...
  public String getEntityText(int addr) {
      ...
      jcas.throwFeatMissing("entityText", "edu.cmu.deiis.sentence.GeneEntity");
