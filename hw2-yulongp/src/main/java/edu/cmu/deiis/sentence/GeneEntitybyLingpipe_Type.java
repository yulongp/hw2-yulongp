 ...
 * @generated */
public class GeneEntitybyLingpipe_Type extends GeneEntity_Type {
  /** @generated 
  ...
  private final FSGenerator fsGenerator = 
    new FSGenerator() {
      public FeatureStructure createFS(int addr, CASImpl cas) {
  			 if (GeneEntitybyLingpipe_Type.this.useExistingInstance) {
  			   // Return eq fs instance if already created
  		     FeatureStructure fs = GeneEntitybyLingpipe_Type.this.jcas.getJfsFromCaddr(addr);
  		     if (null == fs) {
  		       fs = new GeneEntitybyLingpipe(addr, GeneEntitybyLingpipe_Type.this);
  			   GeneEntitybyLingpipe_Type.this.jcas.putJfsFromCaddr(addr, fs);
  			   return fs;
  		     }
  		     return fs;
        } else return new GeneEntitybyLingpipe(addr, GeneEntitybyLingpipe_Type.this);
  	  }
    };
  /** @generated */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = GeneEntitybyLingpipe.typeIndexID;
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("edu.cmu.deiis.sentence.GeneEntitybyLingpipe");
  ...
  public String getEntityText(int addr) {
      ...
      jcas.throwFeatMissing("entityText", "edu.cmu.deiis.sentence.GeneEntitybyLingpipe");
  ...
  public String getCasProcessId(int addr) {
      ...
      jcas.throwFeatMissing("casProcessId", "edu.cmu.deiis.sentence.GeneEntitybyLingpipe");
  ...
  /** initialize variables to correspond with Cas Type and Features
	 ...
	 * @param casType Type 
	 */
  public GeneEntitybyLingpipe_Type(JCas jcas, Type casType) {
    super(jcas, casType);
